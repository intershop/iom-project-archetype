...
{
    /**
     * Start with 1000 to avoid conflict with ProcessTaskDefDO. The name must
     ...
     */
    EXAMPLE_PT( Integer.valueOf( -9999 ), "CheckSendDebitorPT", "java:global/example-app/SkipSendDebitorPTBean" );
