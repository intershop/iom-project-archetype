...
{
    // start with 1000 to avoid conflicts with ApprovalTypeDefDO
    ...
    EXAMPLE( Integer.valueOf( -999 ), "java:global/ci-project-app/ExampleApprovalPTBean!bakery.logic.service.order.task.ProcessApprovalPT" , "ExampleApproval Description", ObjectTypeDefDO.ORDER);
