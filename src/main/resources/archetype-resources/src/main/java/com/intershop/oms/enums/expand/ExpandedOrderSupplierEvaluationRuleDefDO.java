...
public enum ExpandedOrderSupplierEvaluationRuleDefDO implements OrderSupplierEvaluationRuleDefDOEnumInterface
{
    ...
    EXAMPLE( Integer.valueOf( -999 ), "Test-Rule", "Test-Description", "java:global/ci-project-app/ExampleOrderSupplierEvaluationRuleDefDO", 1001, Boolean.FALSE.booleanValue() );
