...
{
	// start with 10000 to avoid conflicts with TransmissionTypeDefDO
    ...
    APPROVAL_NOTIFICATION(Integer.valueOf(10000), "approval notification", RoleDefDO.BAKERY, ExpandedMessageTypeDefDO.APPROVAL_NOTIFICATION, "approval notification mail.", ShopCustomerMailTransmissionDO.class);
